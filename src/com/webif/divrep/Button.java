...
public class Button extends DivRep {
	...
	public void render(PrintWriter out) {
		...
		String js = "if(!$(this).hasClass(\"divrep_processing\")) { $(this).addClass(\"divrep_processing\"); divrep(\""+getNodeID()+"\", event); } return false;";
		if(confirm) {
		...
		case BUTTON:
			...
			out.write("type='button' id='"+getNodeID()+"' onclick='"+js+"' value='&nbsp;&nbsp;&nbsp;"+
				StringEscapeUtils.escapeHtml(title)+"&nbsp;&nbsp;&nbsp' />");
			break;
		case ALINK:
			out.write("<a ");
			renderClass(out);
