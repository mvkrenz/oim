...
public class SendMail_deprecated {
	...
	public SendMail_deprecated(String from, ArrayList<String> to, String subject, String text){
		this.from = from;
		this.to = to;
	...
	static public void sendErrorEmail(String content) throws MessagingException {
		...
		SendMail_deprecated sendMail = new SendMail_deprecated(from, tos, subject, message);
		sendMail.send();
	}
}
