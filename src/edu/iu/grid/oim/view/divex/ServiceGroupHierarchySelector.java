...
public class ServiceGroupHierarchySelector extends FormElementDEBase<Integer> {
	...
	class ServiceGroupSelector extends ExpandableSelector {
		public ServiceGroupSelector(DivEx _parent) throws SQLException {
			super(_parent);
	...
	class ServiceSelector extends ExpandableSelector {		
		public ServiceSelector(DivEx _parent, int service_group_id) throws SQLException {
			super(_parent);
	...
	public ServiceGroupHierarchySelector(DivEx parent, Context _context, Type _type) throws SQLException {
		super(parent);
		type = _type;
		context = _context;
