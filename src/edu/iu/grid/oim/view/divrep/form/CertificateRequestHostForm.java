...
"-----END CERTIFICATE REQUEST-----");
		csr.setWidth(600);
		new DivRepStaticContent(this, "<p>* Create your CSR on your target hosts using tools such as openssl. <br><pre>umask 077; openssl req -new -newkey rsa:2048 -nodes -keyout hostkey.pem -subj \"/CN=osg-ce.example.edu\"</pre> DN will be overriden by the certificate signer except CN.</p>");
