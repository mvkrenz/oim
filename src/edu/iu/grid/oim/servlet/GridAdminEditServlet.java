...
public class GridAdminEditServlet extends ServletBase implements Servlet {
	private static final long serialVersionUID = 1L;
	static Logger log = Logger.getLogger(GridAdminEditServlet.class);  
	private String current_page = "gridadmin";	
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		...
		try {
			form = new GridAdminFormDE(context, rec, current_page);
